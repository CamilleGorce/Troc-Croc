...
<div id="histoire"><h4>Rechercher un produit</h4></div>
    ...
    <div>
            <section>
                        <h2 class="major"><span><center>SUIVEZ-NOUS</center></span></h2>
                        <ul class="contact"><center>
                            ...
                            <li><a class="icon fa-google-plus" href="https://www.plus.google.com/"><span class="label">Google+</span></a></li></center>
                        </ul>
                    </section>
    </div>
    </body>
